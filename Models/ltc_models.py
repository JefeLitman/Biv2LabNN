"""This file contain the models server to generate the answer to the client
Version: 1.9.4
Made by: Yesid Gutierrez and Edgar Rangel
"""
from tensorflow import keras
from .inception_modules import *
from .encoders_models import *

def get_5_blocks_conv(first_block_input:keras.layers.Layer, with_batch_norm:bool = False, 
    layers_padding:str = "same", layers_activation:str = "relu",
    with_bias:bool = True, regularizers:tuple = (None, None), initializers:tuple = (None, None)):
